...
\begin{document}
  ...
  \section{Käyttöliittymä ja järjestelmän komponentit}
        ...
        (TODO: Käyttäjäsivu on tällä hetkellä hieman "syrjäytynyt" osio, sinne ei pääse navigointipalkista, ja muualta yhteys sinne on vain satunnainen, tällä hetkellä vain keskustelualueen viesteissä on linkki kirjoittajan sivuun)
        (TODO: Controllereiden sisältöä voisi ehkä jakaa, esim. kirjautuminen eri kontrolleriin kuin käyttäjäsivun näyttäminen, mutta toisaalta...)
